        ...
        <div class="caption">
          <div class="container">
            <div class="holder">
              ...
              <strong class="title animated fadeInDown"><?= $slider[$i]->description ?></strong>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="services-board">
    <div class="container">
      ...
      <div class="owl-carousel" id="services-slider">
        ...
        <?php } ?>
        <!-- <div class="item">
          <div class="box board-color-1" style="height: 340px">
            <div class="round-icon"><i class="fa fa-link" aria-hidden="true"></i></div>
            <h3><a href="?page=sekolah">Info Pendidikan</a> </h3>
          </div>
        </div>
        <div class="item">
          <div class="box board-color-2" style="height: 340px">
            <div class="round-icon"><i class="fa fa-link" aria-hidden="true"></i></div>
            <h3><a href="?page=kesehatan">Info Kesehatan</a> </h3>
          </div>
        </div> -->
      </div>
    </div>
            ...
            ?>
              <li>
                ...
                <div class="text-col">
                  ...
                  <a href="?page=v-agenda&id=<?= $event[$i]->idevents ?>" class="btn-style-1">Lihat</a>
                </div>
              </li>
            <?php }; ?>
          </ul>
