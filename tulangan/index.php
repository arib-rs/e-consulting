...
include_once "backend/settings.class.php";
...
<![endif]-->
  ...
  <link rel="stylesheet" href="pengelolaweb/assets/plugins/jquery-datatable/dataTables.bootstrap4.min.css">
...
<body>
  <div id="wrapper">
    <header id="header">
      <section class="top-row">
        <div class="container">
          ...
          <a href="?page=kontak" class="btn-style-1">Kontak</a>
        </div>
      </section>
                        ...
                        <nav>
                          <ul class="navbar-nav">
                            ...
                            <!-- <li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Info<span class="caret"></span></a>
                              <ul class="dropdown-menu" role="menu">
                                <li><a href="?page=visi-misi">Info Sekolah</a></li>
                                <li><a href="?page=dasar-hukum">Info Kesehatan</a></li>
                              </ul>
                            </li> -->
              ...
              <nav class="navbar navbar-inverse">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                  <ul class="nav navbar-nav" id="nav">
                    ...
                    <li><a href="#">Info</a>
                      <ul>
                        <li><a href="?page=sekolah"> Pendidikan </a></li>
                        <li><a href="?page=kesehatan"> Kesehatan </a></li>
                      </ul>
                    </li>
    ...
    <?php
    $arrPages = array('visi-misi', 'sekolah', 'struktur-organisasi', 'pegawai', 'kontak', 'profil-pimpinan', 'tupoksi', 'prestasi-inovasi', 'dasar-hukum', 'layanan', 'informasi', 'agenda', 'download', 'v-sekolah', 'v-agenda', 'v-berita', 'v-inpres', 'v-layanan', 'error', 'pengumuman', 'video', 'kesehatan', 'v-faskes');
    $page = @$_GET['page'];
    if (isset($page)) {
  ...
  <script src="pengelolaweb/assets/bundles/datatablescripts.bundle.js"></script>
  <script src="pengelolaweb/assets/js/pages/tables/jquery-datatable.js"></script>
</body>
