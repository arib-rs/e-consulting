    ...
    <section class="services-board">
        <div class="container">
            <div class="row">
                ...
                <?php } ?>
                <!-- <div class="col-md-3 col-sm-6">
                    <div class="box" style="height: 340px; background:red no-repeat right bottom; color:red;">
                        <div class="round-icon"><i class="fa fa-link" aria-hidden="true"></i></div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="box" style="height: 340px; background:blue no-repeat right bottom; color:red;">
                        <div class="round-icon"><i class="fa fa-link" aria-hidden="true"></i></div>
