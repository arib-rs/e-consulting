              ...
              <div class="row clearfix">
                ...
                <div class="col-sm-9">
                  <div class="form-group">
                    <input type="text" class="form-control" name="fname" value="<?= $data->full_name ?>" placeholder="Nama lengkap" required />
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <select class="form-control show-tick" required name="level">
                      ...
                      <option <?php if ($data->level === 2) {
                                echo "selected";
                              } ?> value="8">Admin Sekolah</option>
                      <option <?php if ($data->level === 2) {
                                echo "selected";
                              } ?> value="9">Admin Faskes</option>
                    </select>
                  </div>
                  <div class="form-group">
