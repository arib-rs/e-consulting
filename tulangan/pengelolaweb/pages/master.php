  ...
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card">
      <div class="body text-center">
        ...
        <a href=".?_pg=<?= $_GET['_pg'] ?>&_act=<?= encodeUrl('web_settings') ?>">
  ...
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card">
      <div class="body text-center">
        ...
        <a href=".?_pg=<?= $_GET['_pg'] ?>&_act=<?= encodeUrl('list_users') ?>">
          <h6>Pengaturan User</h6>
        </a>
  ...
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card">
      <div class="body text-center">
        ...
        <a href=".?_pg=<?= $_GET['_pg'] ?>&_act=<?= encodeUrl('download') ?>">
          <h6>Pengaturan Download</h6>
        </a>
  ...
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card">
      <div class="body text-center">
        ...
        <a href=".?_pg=<?= $_GET['_pg'] ?>&_act=<?= encodeUrl('list_api') ?>">
          <h6>Pengaturan Link Api</h6>
        </a>
...
<div class="row clearfix">
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card">
      <div class="body text-center">
        ...
        <a href=".?_pg=<?= $_GET['_pg'] ?>&_act=<?= encodeUrl('banner_settings') ?>">
          <h6>Pengaturan Banner</h6>
        </a>
  ...
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card">
      <div class="body text-center">
        ...
        <a href=".?_pg=<?= $_GET['_pg'] ?>&_act=<?= encodeUrl('services_sets') ?>">
          <h6>Pengaturan Layanan</h6>
        </a>
  ...
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card">
      <div class="body text-center">
        ...
        <a href=".?_pg=<?= $_GET['_pg'] ?>&_act=<?= encodeUrl('video_settings') ?>">
          <h6>Pengaturan video</h6>
        </a>
  ...
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card">
      <div class="body text-center">
        ...
        <a href=".?_pg=<?= $_GET['_pg'] ?>&_act=<?= encodeUrl('employees') ?>">
          <h6>Pengaturan Daftar Pegawai</h6>
        </a>
  ...
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card">
      <div class="body text-center">
        ...
        <a href=".?_pg=<?= $_GET['_pg'] ?>&_act=<?= encodeUrl('profil_pimpinan') ?>">
          <h6>Pengaturan Profil Pimpinan</h6>
        </a>
  ...
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card">
      <div class="body text-center">
        ...
        <a href=".?_pg=<?= $_GET['_pg'] ?>&_act=<?= encodeUrl('dinas') ?>">
          <h6>Pengaturan Dinas Terkait</h6>
        </a>
  ...
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card">
      <div class="body text-center">
        <div class="chart easy-pie-chart-1" data-percent="49"> <span><img src="../images/default/sekolah.jpg" alt="user" class="rounded-circle" /></span> </div>
        <a href=".?_pg=<?= $_GET['_pg'] ?>&_act=<?= encodeUrl('sekolah') ?>">
          <h6>Pengaturan Sekolah</h6>
        </a>
        <small>Tambah, edit, hapus Sekolah</small>
      </div>
    </div>
  </div>
  <div class="col-lg-3 col-md-6 col-sm-12">
    <div class="card">
      <div class="body text-center">
        <div class="chart easy-pie-chart-1" data-percent="49"> <span><img src="../images/default/faskes.png" alt="user" class="rounded-circle" /></span> </div>
        <a href=".?_pg=<?= $_GET['_pg'] ?>&_act=<?= encodeUrl('faskes') ?>">
          <h6>Pengaturan Faskes</h6>
        </a>
        <small>Tambah, edit, hapus Faskes</small>
      </div>
    </div>
  </div>
</div>